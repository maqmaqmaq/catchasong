...
var app = new Vue({
  ...
  mounted() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default()({ method: "GET", "url": "https://itunes.apple.com/search?country=US&media=music&term=my&entity=song&genre=14"}).then(result => {
